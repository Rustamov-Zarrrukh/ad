...
// //1. создать функцию findPersonsByCity которая принимает название города из промпта по которому возвращает массив людей из этого города
...
// findPersonsByCity(cityName, persons)
